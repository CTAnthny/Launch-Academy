...
twitter_data.each do |hash|
  hash.each do |handle, info|
    if info["description"].nil?
      puts "#{handle}: #{info["description"] = "NA"}"
    else
      puts "#{handle}: #{info["description"]}"
    end
  end
end
...
twitter_data.each do |hash|
  hash.each do |handle, info|
    puts "#{handle}: #{info["number of followers"]}"
  end
end
...
twitter_data.each do |hash|
  hash.each do |handle, info|
    puts "#{handle}: #{info["latest tweet"].length}"
  end
end
...
twitter_data.each do |hash|
  hash.each do |handle, info|
    total_char_count = info["last twenty tweets"].inject(0) do |sum, tweet|
      sum += tweet.length
    end
    puts "#{handle}: #{total_char_count}"
  end
end
...
twitter_data.each do |hash|
  hash.each do |handle, info|
    if info["number of followers"] > highest_follows
      highest_follows = info["number of followers"]
      most_followers = handle
    end
  end
end
puts most_followers
...
twitter_data.each do |hash|
  hash.each do |handle, info|
    if info["number of friends"] > highest_friends
      highest_friends = info["number of friends"]
      most_friends = handle
    end
  end
end
...
highest_number_tweets = 0
most_tweets = nil
twitter_data.each do |hash|
  hash.each do |handle, info|
    if info["number of tweets"] > highest_number_tweets
      highest_number_tweets = info["number of tweets"]
      most_tweets = handle
    end
  end
end
